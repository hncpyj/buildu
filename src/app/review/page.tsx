...
//     const handleSaveFeedback = () => {
//         if (!feedback) return alert("No AI feedback to save!");
//         localStorage.setItem("saved_ai_feedback", feedback); // ✅ 저장
//         alert("Feedback saved successfully! ✅");
//     };

//     // ✅ 불러오기 기능 추가
//     const handleLoadFeedback = () => {
//         const savedFeedback = localStorage.getItem("saved_ai_feedback");
//         if (savedFeedback) {
//             setFeedback(savedFeedback);
//             alert("Saved feedback loaded! ✅");
//         } else {
...
//             <Link href="/" className="absolute top-4 left-4 flex items-center gap-2 text-blue-500 hover:text-blue-700">
